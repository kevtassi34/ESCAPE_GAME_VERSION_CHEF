...
public class Indice2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question2_view); // Pour faire le lien avec l'affichage de la question de l'indice dans le layout
        reponse = findViewById(R.id.reponse2_txt);// pour faire le lien avec le champs de reponse a l'indice dans son fichier layout
        valider = findViewById(R.id.indice2_btn);//pour faire le lien avec le bouton vaider du de son fichier layout
        commentaire = findViewById(R.id.IndiceReponse2_view);// pour faire le lien avec le commentaire qui s'affiche quand tu repond a la question
        indice = findViewById(R.id.image2View);// pour faire le lien avec l'image de l'indice qui s'affiche apres avoir repondu a la question
        indice_comment = findViewById(R.id.Indice2_view);// pour faire le lien avec le commentaire de l'indice qui s'affiche apres avoir repondu a la question
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (test.compareTo("20") ==0){
                    ...
                    indice_comment.setText("Utilisez vos sens pour me trouver!");// pour afficher le commentaire de l'indice en cas de bonne reponse a la question posé
                    trouve = true;
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Indice2Activity.this, Enigme2Activity.class);// permet de retourner vers l'activite Enigme2Activity
