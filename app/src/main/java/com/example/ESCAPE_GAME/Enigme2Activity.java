...
public class Enigme2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme2_view); // Lien avec le layout
        nbindice = findViewById(R.id.nbindice2_view); // Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme2_txt); // Lien avec le layout
        valider = findViewById(R.id.validerEnigme2_btn); // Lien avec le layout
        indice1 = findViewById(R.id.indice2_btn); // Lien avec le layout
        ...
        Boolean cc2 = sharedPreferences.getBoolean("2", false);//Récupération des preferences
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme2Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee2_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorsque l'utilisateur appuie sur le bouton indice
                ...
                editor.putBoolean("2", NombreIndice);
                ...
                Bundle bundle = new Bundle();
                bundle.putBoolean("indices2_txt", trouve);
                intent.putExtras(bundle);
                startActivity(intent);
