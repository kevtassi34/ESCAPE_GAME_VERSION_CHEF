...
public class Indice3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question3_view);// Pour faire le lien avec l'affichage de la question de l'indice dans le layout
        reponse = findViewById(R.id.reponse3_txt);// pour faire le lien avec le champs de reponse a l'indice dans son fichier layout
        valider = findViewById(R.id.indice3_btn);//pour faire le lien avec le bouton vaider du de son fichier layout
        commentaire = findViewById(R.id.IndiceReponse3_view);// pour faire le lien avec le commentaire qui s'affiche quand tu repond a la question
        indice = findViewById(R.id.image3View);// pour faire le lien avec l'image de l'indice qui s'affiche apres avoir repondu a la question
        indice_comment = findViewById(R.id.Indice3_view);// pour faire le lien avec le commentaire de l'indice qui s'affiche apres avoir repondu a la question
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Indice3Activity.this, Enigme3Activity.class);// permet de retourner vers l'activite Enigme3Activity
