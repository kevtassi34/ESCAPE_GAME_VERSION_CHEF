...
public class Indice6Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question6_view);// Pour faire le lien avec l'affichage de la question de l'indice dans le layout
        reponse = findViewById(R.id.reponse6_txt);// pour faire le lien avec le champs de reponse a l'indice dans son fichier layout
        valider = findViewById(R.id.indice6_btn);//pour faire le lien avec le bouton vaider du de son fichier layout
        commentaire = findViewById(R.id.IndiceReponse6_view);// pour faire le lien avec le commentaire qui s'affiche quand tu repond a la question
        indice = findViewById(R.id.image6View);// pour faire le lien avec l'image de l'indice qui s'affiche apres avoir repondu a la question
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (test.compareTo("1969") ==0){
                    commentaire.setText("Bonne réponse !\n\nVoici votre indice :");// pour afficher le texte en cas de mauvaise reponse a la question posé
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Indice6Activity.this, Enigme6Activity.class);// permet de retourner vers l'activite Enigme6Activity
