...
public class Indice7Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question7_view);// Pour faire le lien avec l'affichage de la question de l'indice dans le layout
        valider = findViewById(R.id.indice7_btn);//pour faire le lien avec le bouton vaider du de son fichier layout
        commentaire = findViewById(R.id.IndiceReponse7_view);//pour faire le lien avec le commentaire qui s'affiche quand tu repond a la question
        Box1 = findViewById(R.id.checkbox1);// pour faire le lien avec la checkbox1 de son fichier layout
        Box2 = findViewById(R.id.checkbox2);// pour faire le lien avec la checkbox2 de son fichier layout
        Box3 = findViewById(R.id.checkbox3);// pour faire le lien avec la checkbox3 de son fichier layout
        Box4 = findViewById(R.id.checkbox4);// pour faire le lien avec la checkbox4 de son fichier layout
        test = false; // pour tester la valeur saisir par l'utilisateur

        indice = findViewById(R.id.image7View);// pour faire le lien avec l'image de l'indice qui s'affiche apres avoir repondu a la question
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                vib.vibrate(10);//le checkbox vibre pendant 10 milliseconde
                // si le checkbox2 est selectionnee
                if (Box2.isChecked()) {
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vib.vibrate(10);//le checkbox vibre pendant 10 milliseconde
                Intent intent = new Intent(Indice7Activity.this, Enigme7Activity.class);// permet de retourner vers l'activite Enigme7Activity
